...
class linkedListDataStructure<T> {
  private head: linkedListItem.Node<T>;
  private tail: linkedListItem.Node<T>;

  constructor() {
	this.head = new linkedListItem.Node<T>();
	this.tail = new linkedListItem.Node<T>();
